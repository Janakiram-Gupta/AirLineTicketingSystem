...
<html>
	...
	<body style='background-color: #0077c82e;'>
		...
		<form action="admin_total_hours_aircraft_served_timeinterval_form_handler.php" method="post">
			<div>
					<h2 style="margin-left: 20%;">Total hours that a specific aircraft has served during a specific time interval</h2>
