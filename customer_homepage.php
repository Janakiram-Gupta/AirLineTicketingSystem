				...
				if(empty($data_missing))
				{
					...
					else if($class="business")
					{
						...
						else
						{
    						...
    						echo "</table> <br>";
							echo "<div>";
    						echo "<input type=\"submit\" value=\"Proceed\" name=\"Select\" style=\"margin-left: 300px;\">";
							echo "<input type=\"submit\" value=\"Cancel\" name=\"Select\" style=\"margin: 0px 0px 0px -350px;\">";
							echo "</div>";
    						echo "</form>";
    					}
					}	
