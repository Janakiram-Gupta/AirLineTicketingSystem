...
<html>
	...
	<body style='background-color: #0077c82e;'>
		...
		<form action="admin_most_visited_city_lastmonth_form_handler.php" method="post">
			<div>
					<h2 style="margin-left: 20%;">Most visited city during the last month</h2>
					<div style="margin-left: 29%;">
						<br>
						<br>
						<input type="submit" value="Click to find" name="find">
				</div>
